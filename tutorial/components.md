...
Component properties are attributes that control the aspect and behaviour of UI components and they can be either:
...
Component properties can be defined as literal values, as shown below.
...
Component properties can also be other components as shown below.
...
The next - slightly spooky - example features a callback property value; which is a method to be invoked when an event is triggered.
