...
```load_module
tutorial.component_property_as_literal
```
...
```load_module
tutorial.component_property_as_component
```
...
```load_module
tutorial.component_property_as_callback
```
