...
Calling this app at `app/tutorial.snippets.argument_hash#John` will yield the following.
...
We can't display the result in this page directly as it would clash with the website navigation logic. You can instead follow this [link](tutorial.snippets.argument_hash_update#John) to launch this app and see how the app path is synchronized with the app content when navigating back and forth.
