...
In the previous example we showed how to define dynamic behaviour by passing a callable child. This dynamic behaviour is somewhat similar to Excel formulas except much more general. In Reflect we call **_formula_** any Python callable which depends either directly or indirectly on input component values.
