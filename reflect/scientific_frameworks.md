The technologies below have been originally built by and for the scientific community. They are mostly used for exploratory work and are to some extent also used to build simple business apps.
...
[Streamlit](https://streamlit.io/) has been mainly designed for interactive scientific data visualization, in particular AI models. This is the perfect solution for users who want to render AI results with very little effort.
...
- Strong support for realtime display thanks to its asynchronous design.
- Provides developers with enhanced control over advanced business app design.
...
- Notebooks can be exported into a variety of formats.
